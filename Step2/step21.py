...
if __name__ == "__main__":
    ...
    y1 = x + 3.0
    print(y)  # variable(5.0) int, float타입과도 연산 가능

    x = Variable(np.array(2.0))  # 문제점 1번 해결
    y = 3.0 * x + 1.0
    print(y)  # variable(7.0)

    x = Variable(np.array([1.0]))  # 문제점 2번 해결
    y = np.array([2.0]) + x
    print(y)  # [variable([3.])]
